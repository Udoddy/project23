...
import {handleUserRegistrationWithEmail} from "../../../../utils/auth";
...
const RegisterPage = () => {
    ...
    const handleSubmitForRegistration = async () => {
        const registerHandle = await handleUserRegistrationWithEmail(email,password,firstName,lastName)
        if(registerHandle){
                    ...
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div>
                            ...
                            <Button label="Sign In" className="w-full p-3 text-xl"
                                    onClick={handleSubmitForRegistration}></Button>
                        </div>
                    </div>
                </div>
            </div>
